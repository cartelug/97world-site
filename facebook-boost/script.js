...
OrderWizard.start({
    ...
    "storeKey": "k97_region_fb",
    "service": "Facebook Boost",
    "targetLabel": "Facebook page",
    "targetError": "We need the page name to deliver to",
    "plans": [
        {
            "id": "combo",
            "name": "Everything",
            "note": "Followers + page likes + post reactions",
            "usd": 250,
            "wasUsd": 300,
            "tag": "Ultimate value",
            "hero": true,
            "label": "Everything — 10,000 followers + 10,000 page likes + 20,000 post reactions",
            "feats": [
                {
                    "icon": "fa-user-plus",
                ...
                {
                    "icon": "fa-heart",
                    "text": "10,000 page likes"
                },
                {
                    "icon": "fa-eye",
                    "text": "20,000 post reactions"
                },
                {
                    "icon": "fa-rotate-left",
                    "text": "30-day refill"
