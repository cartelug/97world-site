...
OrderWizard.start({
    ...
    "storeKey": "k97_region_ig",
    "service": "Instagram Boost",
    "targetLabel": "Instagram username",
    "targetError": "We need the username to deliver to",
    "plans": [
        {
            "id": "combo",
            "name": "Everything",
            "note": "Followers + likes + reels views",
            "usd": 250,
            "wasUsd": 300,
            "tag": "Ultimate value",
            "hero": true,
            "label": "Everything — 10,000 followers + 10,000 likes + 20,000 reels views",
            "feats": [
                {
                    "icon": "fa-user-plus",
